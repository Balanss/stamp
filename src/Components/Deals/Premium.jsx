...
import PremiumTierFunction from './premiumTierFunction';
...
const [currentStamp, setCurrentStamp] = useState(null);
    ...
    const handleLike = async (stampId) => {
        ...
        const docRef = doc(db, "PremiumDealStamps", stampId);
        ...
        await runTransaction(db, async (transaction) => {
            ...
            if (likesCollection.includes(currentUser)) {
                ...
                transaction.update(docRef, {
                    likes: stampData.likes - 1,
                    likesCollection: arrayRemove(currentUser)
                });
                ...
                transaction.update(docRef, {
                    likes: stampData.likes + 1,
                    likesCollection: arrayUnion(currentUser)
                });
    ...
    return (
        <div className='text-black mt-[120px] flex flex-col items-center'>
            <PremiumTierFunction setStamps={setStamps}/>
